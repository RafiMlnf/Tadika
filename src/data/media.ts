...
export const categories: GalleryCategory[] = [
    ...
    },
    {
        slug: 'jakarta',
        name: 'Jakarta',
        description: 'City stroll vibes Jakarta',
...
export const trips: TripEntry[] = [
    ...
    {
        id: 'trip-003',
        title: 'Jakarta Stroll',
        location: 'Jakarta',
        date: '2024-08-10',
        description: 'City stroll vibes Jakarta. Mulai dari nge-thrift, café hopping estetik, sampai hunting kuliner malem.',
        coverImage: 'https://images.unsplash.com/photo-1504384308090-c894fdcc538d?w=800&q=80',
